    ...
    <div id="carouselId" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="img/slider2.jpg" height="400px" width="2400px" alt="First slide">
            </div>
            <div class="carousel-item">
                <img src="img/slider3.jpg" height="400px" width="2400px" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img src="img/slider1.jpg" height="400px" width="2400px" alt="Third slide">
            </div>
        </div>
